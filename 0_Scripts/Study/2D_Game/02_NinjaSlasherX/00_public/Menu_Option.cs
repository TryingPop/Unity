...
public class Menu_Option : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        SaveData.LoadOption();
        MenuObject_Button.FindMessage(GameObject.Find("MenuFormA"),
            "Button_VRPad").SetLabelText((SaveData.VRPadEnabled ? "On" : "Off"));
    }
    ...
    void Slidebar_Drag(MenuObject_Slidebar slidebar)
    {
        ...
        Debug.Log(string.Format("{0} : {1}", slidebar.label, slidebar.cursorPosition));
    }
    ...
    void Button_SaveDataReset(MenuObject_Button button)
    {
        ...
        GameObject.Find("MenuFormA").transform.position =
            new Vector3(-100.0f, 0.0f, 0.0f);
        GameObject.Find("MenuFormB").transform.position =
    ...
    void Button_SaveDataReset_Yes(MenuObject_Button button)
    {
        ...
        AppSound.instance.fm.SetVolume("BGM", SaveData.SoundBGMVolume);
        AppSound.instance.fm.SetVolume("SE", SaveData.SoundSEVolume);
        MenuObject_Slidebar[] slidebarList = GameObject.Find("MenuFormA").
            GetComponentsInChildren<MenuObject_Slidebar>();
